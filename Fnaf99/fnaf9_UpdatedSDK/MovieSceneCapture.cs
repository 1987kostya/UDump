...
namespace SDK.Script.MovieSceneCaptureSDK
{
    ...
    {
        public MovieSceneCaptureProtocolBase(ulong addr) : base(addr) { }
    ...
    {
        public MovieSceneAudioCaptureProtocolBase(ulong addr) : base(addr) { }
    }
    public class NullAudioCaptureProtocol : MovieSceneAudioCaptureProtocolBase
    {
        public NullAudioCaptureProtocol(ulong addr) : base(addr) { }
    }
    public class MasterAudioSubmixCaptureProtocol : MovieSceneAudioCaptureProtocolBase
    {
        public MasterAudioSubmixCaptureProtocol(ulong addr) : base(addr) { }
    ...
    {
        public MovieSceneImageCaptureProtocolBase(ulong addr) : base(addr) { }
    }
    public class CompositionGraphCaptureProtocol : MovieSceneImageCaptureProtocolBase
    {
        public CompositionGraphCaptureProtocol(ulong addr) : base(addr) { }
    ...
    {
        public FrameGrabberProtocol(ulong addr) : base(addr) { }
    }
    public class ImageSequenceProtocol : FrameGrabberProtocol
    {
        public ImageSequenceProtocol(ulong addr) : base(addr) { }
    }
    public class CompressedImageSequenceProtocol : ImageSequenceProtocol
    {
        public CompressedImageSequenceProtocol(ulong addr) : base(addr) { }
    ...
    {
        public ImageSequenceProtocol_BMP(ulong addr) : base(addr) { }
    }
    public class ImageSequenceProtocol_PNG : CompressedImageSequenceProtocol
    {
        public ImageSequenceProtocol_PNG(ulong addr) : base(addr) { }
    }
    public class ImageSequenceProtocol_JPG : CompressedImageSequenceProtocol
    {
        public ImageSequenceProtocol_JPG(ulong addr) : base(addr) { }
    }
    public class ImageSequenceProtocol_EXR : ImageSequenceProtocol
    {
        public ImageSequenceProtocol_EXR(ulong addr) : base(addr) { }
    ...
    {
        public MovieSceneCaptureInterface(ulong addr) : base(addr) { }
    }
    public class MovieSceneCapture : Object
    {
        public MovieSceneCapture(ulong addr) : base(addr) { }
    ...
    {
        public LevelCapture(ulong addr) : base(addr) { }
    ...
    {
        public MovieSceneCaptureEnvironment(ulong addr) : base(addr) { }
    ...
    {
        public UserDefinedCaptureProtocol(ulong addr) : base(addr) { }
    ...
    {
        public UserDefinedImageCaptureProtocol(ulong addr) : base(addr) { }
    ...
    {
        public VideoCaptureProtocol(ulong addr) : base(addr) { }
    ...
    {
        public MovieSceneCaptureSettings(ulong addr) : base(addr) { }
    ...
    {
        public CaptureResolution(ulong addr) : base(addr) { }
    ...
    {
        public CapturedPixels(ulong addr) : base(addr) { }
    }
    public class CapturedPixelsID : Object
    {
        public CapturedPixelsID(ulong addr) : base(addr) { }
