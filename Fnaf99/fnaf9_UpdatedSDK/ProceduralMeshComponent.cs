...
namespace SDK.Script.ProceduralMeshComponentSDK
{
    ...
    {
        public KismetProceduralMeshLibrary(ulong addr) : base(addr) { }
    ...
    {
        public ProceduralMeshComponent(ulong addr) : base(addr) { }
    ...
    {
        public ProcMeshSection(ulong addr) : base(addr) { }
    ...
    {
        public ProcMeshVertex(ulong addr) : base(addr) { }
    ...
    {
        public ProcMeshTangent(ulong addr) : base(addr) { }
