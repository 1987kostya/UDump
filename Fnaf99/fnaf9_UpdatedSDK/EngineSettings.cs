...
namespace SDK.Script.EngineSettingsSDK
{
    ...
    public class GeneralProjectSettings : Object
    {
        ...
        public bool bStartInAR { get { return this[nameof(bStartInAR)].Flag; } set { this[nameof(bStartInAR)].Flag = value; } }
        public bool bSupportAR { get { return this[nameof(bSupportAR)].Flag; } set { this[nameof(bSupportAR)].Flag = value; } }
