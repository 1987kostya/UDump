...
namespace SDK.Script.Paper2DSDK
{
    ...
    {
        public MaterialExpressionSpriteTextureSampler(ulong addr) : base(addr) { }
    ...
    {
        public PaperCharacter(ulong addr) : base(addr) { }
    ...
    {
        public PaperFlipbook(ulong addr) : base(addr) { }
    ...
    {
        public PaperFlipbookActor(ulong addr) : base(addr) { }
    ...
    {
        public PaperFlipbookComponent(ulong addr) : base(addr) { }
    ...
    {
        public PaperGroupedSpriteActor(ulong addr) : base(addr) { }
    ...
    {
        public PaperGroupedSpriteComponent(ulong addr) : base(addr) { }
    ...
    {
        public PaperRuntimeSettings(ulong addr) : base(addr) { }
    ...
    {
        public PaperSprite(ulong addr) : base(addr) { }
    ...
    {
        public PaperSpriteActor(ulong addr) : base(addr) { }
    ...
    {
        public PaperSpriteAtlas(ulong addr) : base(addr) { }
    }
    public class PaperSpriteBlueprintLibrary : BlueprintFunctionLibrary
    {
        public PaperSpriteBlueprintLibrary(ulong addr) : base(addr) { }
    ...
    {
        public PaperSpriteComponent(ulong addr) : base(addr) { }
    ...
    {
        public PaperTerrainActor(ulong addr) : base(addr) { }
    ...
    {
        public PaperTerrainComponent(ulong addr) : base(addr) { }
    ...
    {
        public PaperTerrainMaterial(ulong addr) : base(addr) { }
    ...
    {
        public PaperTerrainSplineComponent(ulong addr) : base(addr) { }
    }
    public class PaperTileLayer : Object
    {
        public PaperTileLayer(ulong addr) : base(addr) { }
    ...
    {
        public PaperTileMap(ulong addr) : base(addr) { }
    ...
    {
        public PaperTileMapActor(ulong addr) : base(addr) { }
    ...
    {
        public PaperTileMapComponent(ulong addr) : base(addr) { }
        public int MapWidth { get { return this[nameof(MapWidth)].GetValue<int>(); } set { this[nameof(MapWidth)].SetValue<int>(value); } }
        public int MapHeight { get { return this[nameof(MapHeight)].GetValue<int>(); } set { this[nameof(MapHeight)].SetValue<int>(value); } }
        public int TileWidth { get { return this[nameof(TileWidth)].GetValue<int>(); } set { this[nameof(TileWidth)].SetValue<int>(value); } }
        public int TileHeight { get { return this[nameof(TileHeight)].GetValue<int>(); } set { this[nameof(TileHeight)].SetValue<int>(value); } }
    ...
    {
        public PaperTileSet(ulong addr) : base(addr) { }
    ...
    {
        public TileMapBlueprintLibrary(ulong addr) : base(addr) { }
    ...
    {
        public IntMargin(ulong addr) : base(addr) { }
    ...
    {
        public PaperFlipbookKeyFrame(ulong addr) : base(addr) { }
    ...
    {
        public SpriteInstanceData(ulong addr) : base(addr) { }
    ...
    {
        public PaperSpriteSocket(ulong addr) : base(addr) { }
    ...
    {
        public PaperSpriteAtlasSlot(ulong addr) : base(addr) { }
    ...
    {
        public PaperTerrainMaterialRule(ulong addr) : base(addr) { }
    ...
    {
        public PaperTileInfo(ulong addr) : base(addr) { }
        public PaperTileSet TileSet { get { return this[nameof(TileSet)].As<PaperTileSet>(); } set { this["TileSet"] = value; } }
    ...
    {
        public PaperTileSetTerrain(ulong addr) : base(addr) { }
    ...
    {
        public PaperTileMetadata(ulong addr) : base(addr) { }
    ...
    {
        public SpriteGeometryCollection(ulong addr) : base(addr) { }
    ...
    {
        public SpriteGeometryShape(ulong addr) : base(addr) { }
    ...
    {
        public SpriteDrawCallRecord(ulong addr) : base(addr) { }
    ...
    {
        public SpriteAssetInitParameters(ulong addr) : base(addr) { }
    }
}
