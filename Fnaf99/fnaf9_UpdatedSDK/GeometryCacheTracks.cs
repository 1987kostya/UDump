...
namespace SDK.Script.GeometryCacheTracksSDK
{
    ...
    {
        public MovieSceneGeometryCacheSection(ulong addr) : base(addr) { }
    ...
    {
        public MovieSceneGeometryCacheTrack(ulong addr) : base(addr) { }
    ...
    {
        public MovieSceneGeometryCacheParams(ulong addr) : base(addr) { }
    ...
    {
        public MovieSceneGeometryCacheSectionTemplate(ulong addr) : base(addr) { }
    ...
    {
        public MovieSceneGeometryCacheSectionTemplateParameters(ulong addr) : base(addr) { }
