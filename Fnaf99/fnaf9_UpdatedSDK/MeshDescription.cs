...
namespace SDK.Script.MeshDescriptionSDK
{
    ...
    {
        public MeshDescription(ulong addr) : base(addr) { }
    }
    public class MeshDescriptionBase : Object
    {
        public MeshDescriptionBase(ulong addr) : base(addr) { }
    ...
    {
        public ElementID(ulong addr) : base(addr) { }
    ...
    {
        public PolygonGroupID(ulong addr) : base(addr) { }
    }
    public class PolygonID : ElementID
    {
        public PolygonID(ulong addr) : base(addr) { }
    }
    public class VertexID : ElementID
    {
        public VertexID(ulong addr) : base(addr) { }
    }
    public class VertexInstanceID : ElementID
    {
        public VertexInstanceID(ulong addr) : base(addr) { }
    }
    public class EdgeID : ElementID
    {
        public EdgeID(ulong addr) : base(addr) { }
    }
    public class TriangleID : ElementID
    {
        public TriangleID(ulong addr) : base(addr) { }
    }
}
