...
namespace SDK.Script.MediaAssetsSDK
{
    ...
    public class MediaPlayer : Object
    {
        ...
        public Timespan GetLastVideoSampleProcessedTime() { return Invoke<Timespan>(nameof(GetLastVideoSampleProcessedTime)); }
        public Timespan GetLastAudioSampleProcessedTime() { return Invoke<Timespan>(nameof(GetLastAudioSampleProcessedTime)); }
