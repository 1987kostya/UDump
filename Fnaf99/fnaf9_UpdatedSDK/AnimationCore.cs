...
namespace SDK.Script.AnimationCoreSDK
{
    ...
    {
        public AnimationDataSourceRegistry(ulong addr) : base(addr) { }
    ...
    {
        public CCDIKChainLink(ulong addr) : base(addr) { }
    }
    public class Axis : Object
    {
        public Axis(ulong addr) : base(addr) { }
    ...
    {
        public ConstraintData(ulong addr) : base(addr) { }
    ...
    {
        public ConstraintDescriptor(ulong addr) : base(addr) { }
    ...
    {
        public ConstraintDescriptionEx(ulong addr) : base(addr) { }
    ...
    {
        public FilterOptionPerAxis(ulong addr) : base(addr) { }
    ...
    {
        public AimConstraintDescription(ulong addr) : base(addr) { }
    ...
    {
        public TransformConstraintDescription(ulong addr) : base(addr) { }
    ...
    {
        public TransformConstraint(ulong addr) : base(addr) { }
    ...
    {
        public ConstraintDescription(ulong addr) : base(addr) { }
    ...
    {
        public ConstraintOffset(ulong addr) : base(addr) { }
    ...
    {
        public TransformFilter(ulong addr) : base(addr) { }
    ...
    {
        public EulerTransform(ulong addr) : base(addr) { }
    ...
    {
        public FABRIKChainLink(ulong addr) : base(addr) { }
    }
    public class NodeChain : Object
    {
        public NodeChain(ulong addr) : base(addr) { }
    ...
    {
        public NodeHierarchyWithUserData(ulong addr) : base(addr) { }
    ...
    {
        public NodeHierarchyData(ulong addr) : base(addr) { }
    ...
    {
        public NodeObject(ulong addr) : base(addr) { }
    ...
    {
        public TransformNoScale(ulong addr) : base(addr) { }
        public Vector Location { get { return this[nameof(Location)].As<Vector>(); } set { this["Location"] = value; } }
        public Quat Rotation { get { return this[nameof(Rotation)].As<Quat>(); } set { this["Rotation"] = value; } }
    }
}
