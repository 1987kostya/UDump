...
namespace SDK.Script.AkAudioSDK
{
    ...
    {
        public AkAcousticTextureSetComponent(ulong addr) : base(addr) { }
    }
    ...
    {
        public DrawPortalComponent(ulong addr) : base(addr) { }
    }
    public class DrawRoomComponent : PrimitiveComponent
    {
        public DrawRoomComponent(ulong addr) : base(addr) { }
    }
    public class AkFolder : AkAudioType
    {
        public AkFolder(ulong addr) : base(addr) { }
    ...
    {
        public AkPlatformInitialisationSettingsBase(ulong addr) : base(addr) { }
    }
    ...
    public class AkPS5PlatformInfo : AkPlatformInfo
    {
    ...
    {
        public AkSubmixInputComponent(ulong addr) : base(addr) { }
    ...
    {
        public AkXSXPlatformInfo(ulong addr) : base(addr) { }
    }
    ...
    {
        public AkOutputSettings(ulong addr) : base(addr) { }
    ...
    public class AkPS5AdvancedInitializationSettings : AkAdvancedInitializationSettingsWithMultiCoreRendering
    {
        ...
        public bool UseHardwareCodecLowLatencyMode { get { return this[nameof(UseHardwareCodecLowLatencyMode)].Flag; } set { this[nameof(UseHardwareCodecLowLatencyMode)].Flag = value; } }
        public bool bVorbisHwAcceleration { get { return this[nameof(bVorbisHwAcceleration)].Flag; } set { this[nameof(bVorbisHwAcceleration)].Flag = value; } }
    }
    public class AkReverbDescriptor : Object
    {
        public AkReverbDescriptor(ulong addr) : base(addr) { }
    }
    public class AkAcousticTextureParams : Object
    {
        public AkAcousticTextureParams(ulong addr) : base(addr) { }
    ...
    {
        public AkSurfacePoly(ulong addr) : base(addr) { }
    ...
    {
        public AkSurfaceEdgeInfo(ulong addr) : base(addr) { }
    }
    public class AkSurfaceEdgeVerts : Object
    {
        public AkSurfaceEdgeVerts(ulong addr) : base(addr) { }
    }
