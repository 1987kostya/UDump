...
namespace SDK.Script.ClothingSystemRuntimeNvSDK
{
    ...
    {
        public ClothConfigNv(ulong addr) : base(addr) { }
    ...
    {
        public ClothingSimulationFactoryNv(ulong addr) : base(addr) { }
    }
    public class ClothingSimulationInteractorNv : ClothingSimulationInteractor
    {
        public ClothingSimulationInteractorNv(ulong addr) : base(addr) { }
    ...
    {
        public ClothPhysicalMeshDataNv_Legacy(ulong addr) : base(addr) { }
    ...
    {
        public ClothConstraintSetupNv(ulong addr) : base(addr) { }
